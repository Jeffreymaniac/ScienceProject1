...
gdjs.Game_32SceneCode.GDWoodYellowBarObjects1= [];
gdjs.Game_32SceneCode.GDWoodYellowBarObjects2= [];
gdjs.Game_32SceneCode.GDWoodYellowBarObjects3= [];
gdjs.Game_32SceneCode.GDWoodYellowBarObjects4= [];
gdjs.Game_32SceneCode.GDSpikesObjects1= [];
gdjs.Game_32SceneCode.GDSpikesObjects2= [];
gdjs.Game_32SceneCode.GDSpikesObjects3= [];
gdjs.Game_32SceneCode.GDSpikesObjects4= [];
gdjs.Game_32SceneCode.GDCannonBallObjects1= [];
gdjs.Game_32SceneCode.GDCannonBallObjects2= [];
gdjs.Game_32SceneCode.GDCannonBallObjects3= [];
gdjs.Game_32SceneCode.GDCannonBallObjects4= [];
gdjs.Game_32SceneCode.GDLadderShortObjects1= [];
gdjs.Game_32SceneCode.GDLadderShortObjects2= [];
gdjs.Game_32SceneCode.GDLadderShortObjects3= [];
gdjs.Game_32SceneCode.GDLadderShortObjects4= [];
gdjs.Game_32SceneCode.GDYouWOnObjects1= [];
gdjs.Game_32SceneCode.GDYouWOnObjects2= [];
gdjs.Game_32SceneCode.GDYouWOnObjects3= [];
gdjs.Game_32SceneCode.GDYouWOnObjects4= [];
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17557220);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17562036);
}
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(1).setBoolean(false);
}}
...
gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.Game_32SceneCode.GDPlayerObjects1});
gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDSpikesObjects1Objects = Hashtable.newFrom({"Spikes": gdjs.Game_32SceneCode.GDSpikesObjects1});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics3d.areObjectsColliding(gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDPlayerObjects2Objects, "Physics3D", gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDGroundObjects2Objects, "Physics3D", false);
if (isConditionTrue_0) {
/* Reuse gdjs.Game_32SceneCode.GDPlayerObjects2 */
{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects2[i].setPosition(644,900);
}
}{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects2.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects2[i].getBehavior("Object3D").setZ(10);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics3d.areObjectsColliding(gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDPlayerObjects1Objects, "Physics3D", gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDSpikesObjects1Objects, "Physics3D", false);
if (isConditionTrue_0) {
/* Reuse gdjs.Game_32SceneCode.GDPlayerObjects1 */
{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects1[i].setPosition(644,900);
}
}{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects1.length ;i < len;++i) {
...
gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDLadderShortObjects1Objects = Hashtable.newFrom({"LadderShort": gdjs.Game_32SceneCode.GDLadderShortObjects1});
gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.Game_32SceneCode.GDPlayerObjects1});
gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDYouWOnObjects1Objects = Hashtable.newFrom({"YouWOn": gdjs.Game_32SceneCode.GDYouWOnObjects1});
gdjs.Game_32SceneCode.eventsList11 = function(runtimeScene) {

{

gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Game_32SceneCode.GDPlayerObjects1);
gdjs.copyArray(runtimeScene.getObjects("WoodYellowBar"), gdjs.Game_32SceneCode.GDWoodYellowBarObjects1);
gdjs.copyArray(runtimeScene.getObjects("YouWOn"), gdjs.Game_32SceneCode.GDYouWOnObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics3d.areObjectsColliding(gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDPlayerObjects1Objects, "Physics3D", gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDYouWOnObjects1Objects, "Physics3D", false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Game_32SceneCode.GDWoodYellowBarObjects1.length;i<l;++i) {
    if ( gdjs.Game_32SceneCode.GDWoodYellowBarObjects1[i].IsFull((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Game_32SceneCode.GDWoodYellowBarObjects1[k] = gdjs.Game_32SceneCode.GDWoodYellowBarObjects1[i];
        ++k;
    }
}
gdjs.Game_32SceneCode.GDWoodYellowBarObjects1.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
}{gdjs.evtTools.sound.playMusic(runtimeScene, "street-fighter-ii-you-win-perfect.mp3", false, 100, 1);
}}
...
}{for(var i = 0, len = gdjs.Game_32SceneCode.GDWoodYellowBarObjects1.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDWoodYellowBarObjects1[i].SetValue(runtimeScene.getScene().getVariables().getFromIndex(2).getAsNumber(), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
for (var i = 0, k = 0, l = gdjs.Game_32SceneCode.GDPlayerObjects1.length;i<l;++i) {
    if ( !(gdjs.Game_32SceneCode.GDPlayerObjects1[i].getBehavior("PhysicsCharacter3D").isMovingEvenALittle()) ) {
        isConditionTrue_0 = true;
...
/* Reuse gdjs.Game_32SceneCode.GDPlayerObjects1 */
{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects1[i].getBehavior("Animation").setAnimationName("Idle");
}
}{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects1[i].getBehavior("Animation").resumeAnimation();
}
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Game_32SceneCode.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.Game_32SceneCode.GDPlayerObjects1[i].hasNoForces() ) {
        isConditionTrue_0 = true;
        gdjs.Game_32SceneCode.GDPlayerObjects1[k] = gdjs.Game_32SceneCode.GDPlayerObjects1[i];
        ++k;
    }
...
gdjs.copyArray(runtimeScene.getObjects("LadderShort"), gdjs.Game_32SceneCode.GDLadderShortObjects1);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Game_32SceneCode.GDPlayerObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics3d.areObjectsColliding(gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDPlayerObjects1Objects, "Physics3D", gdjs.Game_32SceneCode.mapOfGDgdjs_9546Game_959532SceneCode_9546GDLadderShortObjects1Objects, "Physics3D", false);
if (isConditionTrue_0) {
/* Reuse gdjs.Game_32SceneCode.GDPlayerObjects1 */
{for(var i = 0, len = gdjs.Game_32SceneCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.Game_32SceneCode.GDPlayerObjects1[i].getBehavior("Object3D").setZ(gdjs.Game_32SceneCode.GDPlayerObjects1[i].getBehavior("Object3D").getZ() + (20));
}
}}
...
gdjs.Game_32SceneCode.GDWoodYellowBarObjects1.length = 0;
gdjs.Game_32SceneCode.GDWoodYellowBarObjects2.length = 0;
gdjs.Game_32SceneCode.GDWoodYellowBarObjects3.length = 0;
gdjs.Game_32SceneCode.GDWoodYellowBarObjects4.length = 0;
...
gdjs.Game_32SceneCode.GDSpikesObjects4.length = 0;
gdjs.Game_32SceneCode.GDCannonBallObjects1.length = 0;
gdjs.Game_32SceneCode.GDCannonBallObjects2.length = 0;
gdjs.Game_32SceneCode.GDCannonBallObjects3.length = 0;
gdjs.Game_32SceneCode.GDCannonBallObjects4.length = 0;
gdjs.Game_32SceneCode.GDLadderShortObjects1.length = 0;
gdjs.Game_32SceneCode.GDLadderShortObjects2.length = 0;
gdjs.Game_32SceneCode.GDLadderShortObjects3.length = 0;
gdjs.Game_32SceneCode.GDLadderShortObjects4.length = 0;
gdjs.Game_32SceneCode.GDYouWOnObjects1.length = 0;
gdjs.Game_32SceneCode.GDYouWOnObjects2.length = 0;
gdjs.Game_32SceneCode.GDYouWOnObjects3.length = 0;
gdjs.Game_32SceneCode.GDYouWOnObjects4.length = 0;
